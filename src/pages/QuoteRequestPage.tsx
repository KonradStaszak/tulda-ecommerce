...
const blank: QuoteRequestForm = { firstName: '', lastName: '', company: '', email: '', phone: '', notes: '' }
...
export default function QuoteRequestPage() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    if (!form.firstName.trim() || !form.lastName.trim() || !form.email.trim() || !form.phone.trim()) { setError('Please provide your name, email address and phone number.'); return }
    setBusy(true)
