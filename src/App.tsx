...
function Storefront({ data: catalogue, loading: catalogueLoading, error: catalogueError }: ReturnType<typeof useCatalogue>) {
  ...
  return <div className="tulda-storefront flex min-h-screen flex-col" style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }}>
    <ScrollToTop />
...
<Route path="/" element={<main><Seo /><Hero /><ShopByCategory categories={categories} products={products} loading={catalogueLoading} /><PopularProducts products={products} categories={categories} loading={catalogueLoading} error={catalogueError} onAddToCart={addToCart} wishlist={wishlist} onToggleWishlist={handleToggleWishlist} /><BodyshopSection /><WorkshopGallery /><TechnicalResources limit={6} /><ContactCTA /><Footer /></main>} />
      ...
      <Route path="/wishlist" element={<><Seo title="Saved Products | Tulda" noIndex /><WishlistPage products={products} wishlist={wishlist} isAuthenticated={isAuthenticated} onAddToCart={addToCart} onToggleWishlist={handleToggleWishlist} /><Footer /></>} />
      <Route path="/cart" element={<><Seo title="Your Enquiry | Tulda" noIndex /><CartPage /><Footer /></>} />
      <Route path="/checkout" element={<><Seo title="Request a Quote | Tulda" noIndex /><QuoteRequestPage /><Footer /></>} />
      <Route path="/technical-documents" element={<main><Seo title="Technical Data Sheets & Safety Documents | Tulda UK" description="Find Tulda technical data sheets and safety data sheets for professional automotive refinishing products." /><TechnicalResources /><Footer /></main>} />
      <Route path="/contact" element={<main><Seo title="Contact Tulda | Automotive Refinishing Support UK" description="Contact Tulda for professional automotive refinishing product advice, technical support and UK delivery enquiries." /><ContactCTA /><Footer /></main>} />
      <Route path="/about" element={<><Seo title="About Tulda | Professional Bodyshop Products UK" description="Learn about Tulda's professional automotive refinishing range for UK bodyshops." /><AboutPage /><Footer /></>} />
      <Route path="/account" element={<><Seo title="Your Account | Tulda" noIndex /><AccountPage /><Footer /></>} />
      <Route path="/admin" element={<><Seo title="Administration | Tulda" noIndex /><AdminPage /><Footer /></>} />
      <Route path="*" element={<main><Seo title="Page Not Found | Tulda" noIndex /><NotFoundPage /><Footer /></main>} />
    </Routes>
  </div>
}
