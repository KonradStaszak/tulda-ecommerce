      ...
      <div className="mx-auto max-w-[1400px] px-6">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="lg:py-4">
            <h2
              className="mb-6 text-4xl font-black leading-none text-[var(--foreground)] md:text-5xl"
            ...
            >
              ...
              WE&apos;LL COME
              <br />
              <span className="text-[var(--primary)]">TO YOUR SHOP.</span>
            </h2>
            ...
            <div className="space-y-5">
              {contactDetails.map((item) => (
                <div key={item.label} className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="mb-0.5 text-xs font-semibold tracking-[0.08em] text-[var(--muted-foreground)]">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[#e3e9ed] bg-white p-6 shadow-[0_20px_50px_rgba(15,26,32,0.07)] sm:p-9">
            ...
            {submitted ? (
              <div className="flex min-h-[360px] flex-col items-center justify-center text-center">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[var(--primary)]">
                  <svg
                ...
                <h3
                  className="mb-2 text-2xl font-black text-[var(--foreground)]"
                  style={{ fontFamily: "Barlow Condensed, sans-serif" }}
                >
                  REQUEST RECEIVED
                </h3>
                <p className="text-sm text-[var(--muted-foreground)]">
                  We&apos;ll be in touch within one business day to arrange your
                  demo.
                </p>
              </div>
            ) : (
              <form onSubmit={submit} className="space-y-4">
                ...
                <button
                  disabled={busy}
                  type="submit"
                  className="tulda-button w-full justify-center rounded-lg py-3.5 disabled:opacity-60"
                >
