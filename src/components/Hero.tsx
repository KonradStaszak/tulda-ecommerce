      ...
      <div className="relative z-[2] mx-auto flex w-full max-w-[1400px] flex-1 items-start px-6 pb-4 pt-20 md:min-h-[590px] md:pb-20 md:pt-36">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-white/85 md:mt-7 md:text-lg">
            Professional clearcoats, primers, abrasives and fillers for smart
            repairs, small and localised repairs, larger jobs and full resprays,
            with consistent results at every stage.
          </p>
          <div className="mt-6 flex flex-wrap gap-3 md:mt-8">
            <Link to="/products" className="tulda-button">
              Shop Products <span aria-hidden="true">→</span>
            </Link>
            <Link
              to="/products"
              className="inline-flex min-h-11 items-center justify-center border border-white/60 bg-white/10 px-5 text-xs font-bold text-white transition-colors hover:bg-white hover:text-[#071218]"
            >
              Explore Categories
            </Link>
          </div>
