...
const recommendations: Record<string, Result> = {
  "Bare Metal_Full Respray": {
    ...
    description:
      "Start with PT30 Multiprimer (4:1) for maximum adhesion and corrosion resistance on bare metal. Topcoat with CT90 VHS Clearcoat for a premium gloss finish with long-term durability.",
  },
  ...
  "Aluminium_Panel Repair": {
    ...
    description:
      "Apply BT01 Bodyfiller for levelling. It offers excellent adhesion on aluminium. Prime with PT30, then finish with CT60 for UV-resistant high gloss.",
  },
  ...
  "Existing Paint_Spot Repair": {
    ...
    description:
      "CT50 ECOCLEAR is ideal for fast-turnaround spot repairs, with rapid cure and easy application. Use ST10 thinner to adjust viscosity for spray gun application.",
  },
  ...
  default: {
    ...
    description:
      "For most bodyshop applications, PT30 Multiprimer with CT60 Multi-Clear provides a versatile, proven combination. Contact our technical team for substrate-specific advice.",
  },
}
...
export default function FindProduct() {
  ...
  const result =
    substrate && application
      ? (recommendations[`${substrate}_${application}`] ??
      ...
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            >
              Tell us what you are working with and we will recommend the
              correct Tulda products for your application.
            </p>
              ...
              <div className="flex flex-wrap gap-2">
                {substrates.map((s) => (
                  <button
                    ...
                    style={{
                      borderColor:
                        substrate === s ? "var(--primary)" : "var(--border)",
              ...
              <div className="flex flex-wrap gap-2">
                {applications.map((a) => (
                  <button
                    ...
                    style={{
                      borderColor:
                        application === a ? "var(--primary)" : "var(--border)",
